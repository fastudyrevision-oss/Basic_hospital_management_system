...
$id = $_GET['id'] ?? null;
$medicine = get_by_id('medicine', $id, $pdo);
$error = '';
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($product_name)) {
        ...
        try {
            $stmt = $pdo->prepare("UPDATE medicine SET product_name = ?, duration = ?, dosage = ? WHERE id = ?");
            $stmt->execute([$product_name, $duration, $dosage, $id]);
    ...
    <div class="container">
        ...
        <form method="POST">
            <div class="form-group">
                ...
                <input type="text" id="product_name" name="product_name" value="<?php echo htmlspecialchars($medicine['product_name']); ?>" required>
            </div>

            <div class="form-group">
                <label for="duration">Duration</label>
                <input type="text" id="duration" name="duration" value="<?php echo htmlspecialchars($medicine['duration'] ?? ''); ?>">
            </div>
            ...
            <div>
                <button type="submit" class="btn btn-submit">Update Medicine</button>
