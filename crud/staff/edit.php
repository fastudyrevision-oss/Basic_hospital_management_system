...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($first_name) || empty($last_name)) {
        ...
        try {
            $stmt = $pdo->prepare("UPDATE staff SET first_name = ?, last_name = ?, gender = ?, phone_number = ?, shift_time = ? WHERE id = ?");
            $stmt->execute([$first_name, $last_name, $gender ?: null, $phone, $shift ?: null, $id]);
    ...
    <div class="container">
        ...
        <form method="POST">
            ...
            <div class="form-group">
                ...
                <input type="time" id="shift_time" name="shift_time" value="<?php echo htmlspecialchars($member['shift_time'] ?? ''); ?>">
            </div>
