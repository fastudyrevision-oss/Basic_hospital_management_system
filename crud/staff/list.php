...
<body>
    <div class="container">
        <div class="header">
            <h1>👥 Staff</h1>
            <div>
                <a href="create.php" class="btn btn-add">+ Add New Staff</a>
        ...
        <table>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><?php echo htmlspecialchars($member['shift_time'] ?? 'N/A'); ?></td>
        ...
        <?php if (empty($staff)): ?>
            <p style="text-align: center; margin-top: 20px; color: #666;">No staff found. <a href="create.php">Add one now</a></p>
        <?php endif; ?>
    </div>
</body>
</html>
