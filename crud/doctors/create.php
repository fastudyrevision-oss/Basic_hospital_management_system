...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($first_name) || empty($last_name)) {
        ...
        try {
            $stmt = $pdo->prepare("INSERT INTO doctors (first_name, last_name, speciality, phone_number, email) VALUES (?, ?, ?, ?, ?)");
            $stmt->execute([$first_name, $last_name, $speciality, $phone, $email]);
    ...
    <div class="container">
        ...
        <form method="POST">
            ...
            <div class="form-group">
                ...
                <input type="text" id="speciality" name="speciality" placeholder="e.g., Cardiologist">
            </div>

            <div class="form-group">
                <label for="phone_number">Phone Number</label>
                <input type="tel" id="phone_number" name="phone_number" placeholder="e.g., 0301-4567890">
            </div>

            <div class="form-group">
                <label for="email">Email</label>
                <input type="email" id="email" name="email" placeholder="e.g., doctor@example.com">
            </div>
