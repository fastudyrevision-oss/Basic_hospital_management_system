...
$id = $_GET['id'] ?? null;
$doctor = get_by_id('doctors', $id, $pdo);
$error = '';
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($first_name) || empty($last_name)) {
        ...
        try {
            $stmt = $pdo->prepare("UPDATE doctors SET first_name = ?, last_name = ?, speciality = ?, phone_number = ?, email = ? WHERE id = ?");
            $stmt->execute([$first_name, $last_name, $speciality, $phone, $email, $id]);
    ...
    <div class="container">
        ...
        <form method="POST">
            ...
            <div class="form-group">
                ...
                <input type="text" id="speciality" name="speciality" value="<?php echo htmlspecialchars($doctor['speciality'] ?? ''); ?>">
            </div>

            <div class="form-group">
                <label for="phone_number">Phone Number</label>
                <input type="tel" id="phone_number" name="phone_number" value="<?php echo htmlspecialchars($doctor['phone_number'] ?? ''); ?>">
            </div>
            ...
            <div>
                <button type="submit" class="btn btn-submit">Update Doctor</button>
